...
def alexnet_v2_with_bn_no_drop(*args, **kwargs):
  kwargs['with_bn'] = True
  kwargs['dropout_keep_prob'] = 0
  return alexnet_v2(
      *args, **kwargs)


def alexnet_v2_with_bn(*args, **kwargs):
  kwargs['with_bn'] = True
  return alexnet_v2(
      *args, **kwargs)
